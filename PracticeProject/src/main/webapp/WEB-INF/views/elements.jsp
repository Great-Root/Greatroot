					...
					<div class="row gtr-200">
						<div class="col-6 col-12-medium">
							...
							<p>
								...
								text and this is <sub>subscript</sub> text. This is
								and this is code:
								<code>for (;;) { ... }</code>
						...
						<div class="col-6 col-12-medium">
							...
							<h4>Fit</h4>
							<span class="image fit"><img src="<c:url value='/resources/images/pic11.jpg' />" alt="" /></span>
							<div class="box alt">
								<div class="row gtr-50 gtr-uniform">
									<div class="col-4">
										<span class="image fit"><img src="<c:url value='/resources/images/pic01.jpg' />"
											alt="" /></span>
									</div>
									<div class="col-4">
										<span class="image fit"><img src="<c:url value='/resources/images/pic02.jpg' />"
											alt="" /></span>
									</div>
									<div class="col-4">
										<span class="image fit"><img src="<c:url value='/resources/images/pic03.jpg' />"
											alt="" /></span>
									</div>
									<!-- Break -->
									<div class="col-4">
							...
							<h4>Left &amp; Right</h4>
							<p>
								<span class="image left"><img src="<c:url value='/resources/images/pic01.jpg' />"
							...
							<p>
								<span class="image right"><img src="<c:url value='/resources/images/pic02.jpg' />"
									alt="" /></span>Lorem ipsum dolor sit accumsan interdum nisi, quis
								tincidunt felis sagittis eget. tempus euismod. Vestibulum ante
								ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis
								iaculis volutpat ac adipiscing accumsan eu faucibus. Integer ac
